...
select rname, ename from relates where rname = (	
 	select rname from relates group by rname having count(rname)=3
);
...
--relationships with cardinality of 1 or 2
--relationships with cardinality M on the end that connects to the --entity.
